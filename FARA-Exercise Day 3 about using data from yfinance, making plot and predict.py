# -*- coding: utf-8 -*-
"""
Created on Sun Sep 22 22:07:57 2024

@author: Fara Cholidatun N
"""
...
data = yf.download("NZM2.BE", start=start_date, end=end_date)
...
plt.plot(data.index, y_pred, label= "Interpolation", color='purple')
plt.grid(linestyle=":")
plt.ylabel("Price ($)")
plt.title(f"Novozyme Price from {start_date} to {end_date}")
plt.legend()
